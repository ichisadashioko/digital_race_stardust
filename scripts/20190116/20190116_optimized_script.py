...
class Lane_Detect:
    ...
    def __init__(self):
        ...
        self.fixed_speed = 30 # speed for normal running speed
        self.fixed_turn_speed = 35 # speed for running at intersect
        ...
        self.wait_duration = 0.95  # how long the car will wait before turning
    ...
    def pipeline(self, img):
        ...
        delta = 240 - right_x + self.pos_fix-10
        print(self.pos_fix)
