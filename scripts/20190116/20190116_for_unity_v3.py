...
class Lane_Detect:
    ...
    def __init__(self):
        ...
        self.fixed_angle = 16 # angle for turning at traffic sign
        ...
        self.turn_duration = 1.  # 4 seconds # how long the car will turn
        self.wait_start = 0 # hold the time when recognize traffic sign
        self.wait_duration = 0.65  # how long the car will wait before turning
    ...
    def pipeline(self, img):
        ...
        delta = 240 - left_x - self.pos_fix - 25
        print(self.pos_fix)
